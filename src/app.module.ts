...
@Module({
  imports: [MongooseModule.forRoot('mongodb://localhost/erpdb'),  
    StudentModule, AdminModule, SchoolModule, ClassModule, PrincipleModule, TimetableModule, CourseModule,  AttendenceModule, AsgimentModule, DepartmentModule, QuizModule, VideoModule, ResultModule, TestsesionModule, AcountsModule, SuperadminModule],
